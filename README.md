THIS IS A FORK AND WILL BE UNMAINTAINED PROBABLY. ITS BEING FIXED FOR CUDA 12.8

ALL CREDIT GOES TO THE ORIGINAL CREATOR. I have absoultely no idea how this works, or how it can be improved. I'm just here to fix the CMakeLists.txt so it can be easily used in other projects.
